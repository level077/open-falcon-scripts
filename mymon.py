...
def metric_init(params):
    ...
    descriptors.append(create_desc(Desc_Skel,{
			'metric': _metric_prefix + 'queries_delta',
			})) 
    descriptors.append(create_desc(Desc_Skel,{
                        'metric': _metric_prefix + 'select_delta',
                        }))
    descriptors.append(create_desc(Desc_Skel,{
                        'metric': _metric_prefix + 'update_delta',
                        }))
    descriptors.append(create_desc(Desc_Skel,{
                        'metric': _metric_prefix + 'delete_delta',
                        }))
    descriptors.append(create_desc(Desc_Skel,{
                        'metric': _metric_prefix + 'insert_delta',
                        }))
    descriptors.append(create_desc(Desc_Skel,{
                        'metric': _metric_prefix + 'created_tmp_disk_tables_delta',
                        }))
    descriptors.append(create_desc(Desc_Skel,{
                        'metric': _metric_prefix + 'created_tmp_tables_delta',
                        }))
    descriptors.append(create_desc(Desc_Skel,{
                        'metric': _metric_prefix + 'created_tmp_files_delta',
                        }))
    descriptors.append(create_desc(Desc_Skel,{
                        'metric': _metric_prefix + 'threads_connected',
                        }))
    descriptors.append(create_desc(Desc_Skel,{
                        'metric': _metric_prefix + 'threads_running',
                        }))
    descriptors.append(create_desc(Desc_Skel,{
                        'metric': _metric_prefix + 'binlog_cache_disk_use_delta',
                        }))
    descriptors.append(create_desc(Desc_Skel,{
                        'metric': _metric_prefix + 'innodb_buffer_pool_reads_delta',
                        }))
    descriptors.append(create_desc(Desc_Skel,{
                        'metric': _metric_prefix + 'innodb_buffer_pool_wait_free_delta',
                        }))
    descriptors.append(create_desc(Desc_Skel,{
                        'metric': _metric_prefix + 'innodb_data_pending_fsyncs_delta',
                        }))
    descriptors.append(create_desc(Desc_Skel,{
                        'metric': _metric_prefix + 'innodb_data_pending_reads_delta',
                        }))
    descriptors.append(create_desc(Desc_Skel,{
                        'metric': _metric_prefix + 'innodb_data_pending_writes_delta',
                        }))
    descriptors.append(create_desc(Desc_Skel,{
                        'metric': _metric_prefix + 'innodb_log_waits_delta',
                        }))
    descriptors.append(create_desc(Desc_Skel,{
                        'metric': _metric_prefix + 'innodb_os_log_pending_fsyncs_delta',
                        }))
    descriptors.append(create_desc(Desc_Skel,{
                        'metric': _metric_prefix + 'innodb_os_log_pending_writes_delta',
                        }))
    descriptors.append(create_desc(Desc_Skel,{
                        'metric': _metric_prefix + 'opened_tables',
                        }))
    descriptors.append(create_desc(Desc_Skel,{
                        'metric': _metric_prefix + 'select_full_join_delta',
                        }))
    descriptors.append(create_desc(Desc_Skel,{
                        'metric': _metric_prefix + 'select_range_check_delta',
                        }))
    descriptors.append(create_desc(Desc_Skel,{
                        'metric': _metric_prefix + 'select_scan_delta',
                        }))
    descriptors.append(create_desc(Desc_Skel,{
                        'metric': _metric_prefix + 'slow_queries_delta',
                        }))
    descriptors.append(create_desc(Desc_Skel,{
                        'metric': _metric_prefix + 'sort_merge_passes_delta',
                        }))
    descriptors.append(create_desc(Desc_Skel,{
                        'metric': _metric_prefix + 'table_locks_waited_delta',
                        }))
    descriptors.append(create_desc(Desc_Skel,{
                        'metric': _metric_prefix + 'table_open_cache_misses_delta',
                        }))
    descriptors.append(create_desc(Desc_Skel,{
                        'metric': _metric_prefix + 'threads_created_delta',
                        }))
...
if __name__ == '__main__':
    #params = {'RefreshRate': '2','Host':'10.3.2.37',"Port":"3306","User":"monitor","Password":"monitor"}
    params = {}
    parser = argparse.ArgumentParser(formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    parser.add_argument("-e","--endpoint",help="mysql hostname, used by open-falcon")
    ...
    parser.add_argument("-i","--host",help="mysql ip")
    parser.add_argument("-m","--mysql",help="mysql path",default="/usr/local/mysql/bin/mysql")
    ...
    if args.host:
        ...
        os._exit(1)
    if args.mysql:
        params['Mysql'] = args.mysql
    metric_init(params)
    while True:
        try:
            for d in descriptors:
                #v = mysql_status(d['metric'])
                #print 'value for %s is %u, time is %s' % (d['metric'],  v, int(time.time()))
		d['value'] = mysql_status(d['metric'])
